    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.parentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ExpertHomeActivity.chosenEmail = list.get(position);
                mContext.startActivity(new Intent(mContext, ExpertBrowseActivity.class));
                Toast.makeText(mContext, ExpertHomeActivity.chosenEmail, Toast.LENGTH_SHORT).show();
            }
        });
    }
